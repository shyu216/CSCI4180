...
public class PDNodeWritable implements Writable {
    ...
    private static HashMap<Integer, Integer> adjacentcyList;
    ...
    //     return (HashMap<Integer, Integer>) this.adjacentcyList.clone();
    // }

    // public void setList(HashMap<Integer, Integer> lis) {
    //     this.adjacentcyList =(HashMap<Integer, Integer>) lis.clone();
    //     this.hasL = true;
    // }
